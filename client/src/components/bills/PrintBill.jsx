                ...
                <tbody>
                  <tr className="border-b border-slate-200">
                    <td className="py-4 sm:table-cell hidden">
                      <img
                        src="https://www.medicalpark.com.tr/_uploads/_images/_healthGuide/Jfa80GiN.jpg"
                        alt=""
                ...
                <tfoot>
                  <tr>
                    ...
                    <th className="text-right pt-4" scope="row">
                      <span className="font-normal text-slate-700">35₺</span>
                    </th>
                  </tr>
                  ...
                  <tr>
                    ...
                    <th className="text-right pt-4" scope="row">
                      <span className="font-normal text-slate-700">39.88₺</span>
                    </th>
                  </tr>
                </tfoot>
              </table>
